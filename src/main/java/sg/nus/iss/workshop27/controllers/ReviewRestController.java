package sg.nus.iss.workshop27.controllers;
...
import sg.nus.iss.workshop27.services.ReviewService;
...
public class ReviewRestController {
    ...
    @GetMapping("{reviewId}") //obtain the review based on id
    ...
    @GetMapping("{reviewId}/history") //obtain review history based on id
